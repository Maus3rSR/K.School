---
name: slidev
description: Slidev API reference — syntax, layouts, animations, code blocks, diagrams, export, and CLI. Invoke when looking up Slidev features, options, or building a standalone Slidev project.
---
