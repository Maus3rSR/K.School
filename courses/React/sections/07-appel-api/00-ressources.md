...
📡 [Utiliser Effect pour la synchronisation](https://fr.react.dev/learn/synchronizing-with-effects#fetching-data) - Le pattern fetch + useEffect et ses limites

🎭 [JSONPlaceholder](https://jsonplaceholder.typicode.com/) - Fake API REST gratuite utilisée pendant tout le cours

🌐 [Fetch API — MDN](https://developer.mozilla.org/fr/docs/Web/API/Fetch_API/Using_Fetch) - Faire une requête et lire la réponse
